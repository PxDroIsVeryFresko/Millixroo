...
NotifyLib.prompt('MillixroHUB ', 'Loading..', 5)
wait(2)
NotifyLib.prompt('MillixroHUB', 'milly and nexro god', 5)
NotifyLib.prompt('MillixroHUB', 'milly and nexro god', 5)
--// minecrafto
local Window = Library.CreateLib("Millixro", "Ocean")
...
Section:NewButton("Aimlock", "Q  To lock on people", function()
    NotifyLib.prompt('MillixroHUB', '( Press ( P ) To enable aimlock ) Aimlock Loaded Keybind is { Q } ( made by evan licensed aimlock love u no homo )', 5)
wait(1)
...
--Aimlock Prediction
Section:NewTextBox("Aimlock Prediction", "EL PEPE", function(txt)
getgenv().Prediction = txt
end)
Section:NewToggle("Smoothnes Mode", "ETE SECH", function(ok)
getgenv().SmoothnessMode = ok
end)
Section:NewSlider("Aimlock Fov", "POTAXIO", 500, 0, function(s) -- 500 (MaxValue) | 0 (MinValue)
   getgenv().FOVSize = s
end)
Section:NewTextBox("Aimlock Keybind", "Keybind", function(ad)
getgenv().Key = ad
end)
Section:NewToggle("Aimlock Fov", "TILIN TILIN", function(ok)
getgenv().ShowFOV = ok
end)
...
Section:NewButton("Silent Aim", "Silent Aim!", function()
     NotifyLib.prompt('MillixroHUB', 'Silent Aim Enabled! Credits To Stefanuk12 For Modulev2 ( with license )', 5)
-- // Dependencies
...
Section:NewButton("Silent Aimlock", "Enable", function()
    NotifyLib.prompt('MillixroHUB', 'Credits TO Flash For The Lock ( Hes Main Lock But Thats Paid No One Can Deobfuscate Luraph Stay Safe Flash Nigga )' )
...
Section:NewButton("Enable ESP!", "", function()
     NotifyLib.prompt('MillixroHUB', 'ESP Enabled!', 5)
